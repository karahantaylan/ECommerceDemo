...
namespace ECommerce.WebApp
{
    public class Startup
    {
        ...
        {
            services.AddTransient<IProduct, Product>(); //DI
            services.AddTransient<IOrder, Order>();
            services.AddTransient<ICampaign, Campaign>();
            ...
            services.AddDbContext<CoreDB>(
                options => options.UseSqlServer(Configuration.GetConnectionString("CoreDB"))
                );
